...
{
    public class SampleJarConfig : IBuildingConfig
    {
        public const string Id = "SkyesSampleJar";
        public const string DisplayName = "Sample Jar";
        public const string Description = "Gravitas Sample Jar Replica.\n\nThe berry model of a proto-hatch creature meticulously preserved in a jar. \nLooks very real, but it isn't.";
        ...
        public override BuildingDef CreateBuildingDef()
        {
            var buildingDef = BuildingTemplates.CreateBuildingDef(
                id: Id, //PropGravitasJar2
                width: 1,
                height: 1,
                anim: "gravitas_jar2_kanim",
