...
{
    public class VendingMachineConfig : IBuildingConfig
    {
        public const string Id = "SkyesVendingMachine";
        public const string DisplayName = "Vending Machine";
        public const string Description = "Gravitas Vending Machine Replica.\n\nNon-functioning food dispenser.";
        ...
        public override BuildingDef CreateBuildingDef()
        {
            var buildingDef = BuildingTemplates.CreateBuildingDef(
                id: Id, //VendingMachine
                width: 2,
                height: 3,
                anim: "vendingmachine_kanim",
