...
{
    public class EletronicDisplayConfig : IBuildingConfig
    {
        public const string Id = "SkyesEletronicDisplay";
        public const string DisplayName = "Eletronic Display";
        public const string Description = "Gravitas Eletronic Display Replica. \n\nAn electronic display projecting the blueprint of a ceiling robot.\nSome lights seem to turn on but nothing else works. \nAnd yes, we tried turning it off for 10 seconds and then turning it back on again.";
        ...
        public override BuildingDef CreateBuildingDef()
        {
            var buildingDef = BuildingTemplates.CreateBuildingDef(
                id: Id, //PropGravitasDisplay4
                width: 1,
                height: 3,
                anim: "gravitas_display4_kanim",
